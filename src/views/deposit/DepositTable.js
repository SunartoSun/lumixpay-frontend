...
import { fetchDepositList } from 'src/redux/depositReducer';
import { formatDateRange, getCurrentDate, getDateTomorrow, getStatusBadge, getStatusLabel } from 'src/helper/utils';
...
const DepositTable = ({ onActionClick, onFilterChange }) => {
  ...
  return (
    <CCardBody>
      <CDataTable
        ...
        hover
        loading={loading}
        overTableSlot={<DepositFilter filterValues={filterValue} onFilterChange={handleFilterChange} />}
